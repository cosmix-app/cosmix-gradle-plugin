...
abstract class CosmixExtension @Inject constructor(project: Project) {

    val userCache = project.gradle.gradleUserHomeDir.resolve("caches").resolve("cosmix")
...
fun ExtensionContainer.getCosmix(): CosmixExtension {
    return getByName("cosmix") as CosmixExtension
}
